...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (5, 'Act on Impulse', '2R', 'Exile the top three cards of your library. Until end of turn, you may play cards exiled this way. ' ||
                                   '(If you cast a spell this way, you still pay its costs. You can play a land this way only if you have ' ||
                                   'an available land play remaining.)', NULL, NULL, 'M15', 'U', NULL, NULL, 'Sorcery', 13);
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (6, 'Aegis Angel', '4WW', 'Flying\n\nWhen Aegis Angel enters the battlefield, another target permanent gains indestructible for as long as you control Aegis Angel. ' ||
                                 '(Effects that say "destroy" don''t destroy it. A creature with indestructible can''t be destroyed by damage.)',
        NULL, NULL, 'M15', 'R', 5, 5, 'Creature - Angel', 13);
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (7, 'Chandra, Pyromaster', '2RR', '+1: Chandra, Pyromaster deals 1 damage to target player or planeswalker and 1 damage to up to one target ' ||
                                         'creature that player or that planeswalker''s controller controls. That creature can''t block this turn.\n' ||
        ...
        'Planeswalker', 5);
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (8, 'Chief Engineer', '1B', 'Artifact spells you cast have convoke. (Your creatures can help cast those spells. Each creature you tap while casting an ' ||
                                   'artifact spell pays for 1 or one mana of that creature''s color.)', 'An eye for detail, a mind for numbers, a soul of clockwork.',
