...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20006, 'Shadow Prophecy', '2B', 'Domain - Look at the top X cards of your library, where X is the number of basic land types among lands you control. Put up to two of them into your hand and the rest into your graveyard.You lose 2 life.', 'Lord Windgrace, grant me wisdom.', NULL, 'DMU', 'C', NULL, NULL, 'Instant', 4);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20007, 'Cut Down', 'B', 'Destroy target creature with total power and toughness 5 or less.', 'There can be no mercy, no half measures. When facing Phyrexians, it\'s kill swiftly or die.', NULL, 'DMU', 'U', NULL, NULL, 'Instant', 17);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20008, 'Farewell', '4WW', 'Choose one or more-\n* Exile all artifacts\n* Exile all creatures.\n* Exile all enchantments.\n* Exile all graveyards.', NULL, NULL, 'NEO', 'R', NULL, NULL, 'Sorcery', 3);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20009, 'Depopulate', '2WW', 'Each player who controls a multicolored creature draws a card. Then destroy all creatures.', 'No screams rang out. No blood stained the streets. In a instant, the bustling metropolis simple fell silent.', NULL, 'SNC', 'R', NULL, NULL, 'Sorcery', 3);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20010, 'Slimefoot\'s Survey', '4G', 'Domain - Search your library for up to two land cards that each have a basic land type, put them onto the battlefield tapped, then shuffle. Look at the top X cards of your library, where X is the number of basic land types among lands you control. Put up to one of them on top of your library and the rest on the bottomk of your library in a random order.', NULL, NULL, 'DMU', 'U', NULL, NULL, 'Sorcery', 17);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20011, 'Herd Migration', '6G', 'Domain - Create a 3/3 Beast creature token for each basic land type among lands you control.\n\n1G, Discard Herd Migration: Search your library for a basic land card, reveal it, put it into your hand, then shuffle.', NULL, NULL, 'DMU', 'R', NULL, NULL, 'Sorcery', 9);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20012, 'The Weatherseed Treaty', '2G', 'Read ahead (Choose a chapter and start with that many lore counters. Add one after your draw step. Skipped chapters don\'t trigger. Sacrifice after III.)\n\nI - Search your library for a basic land card, put it onto the battlefield tapped, then shuffle\n\nII - Create a 1/1 green Saproling token.\n\nIII - Domain - Target creature you control gets +X/+X and gains trample until end of term, where X is the number of basic land types among lands you control.', NULL, NULL, 'DMU', 'U', NULL, NULL, 'Enchantment - Saga', 7);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20013, 'Leyline Binding', '5W', 'Flash\n\nDomain - This spell costs 1 less to cast for each basic land type among lands you control.\n\nWhen Leyline Binding enters the battlefield, exile target nonland permanent an opponent controls until Leyline Binding leaves the battlefield.', NULL, NULL, 'DMU', 'R', NULL, NULL, 'Enchantment', 18);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20014, 'Xander\'s Lounge', '', '(Tap: Add U, B, or R.)\n\nXander\'s Lounge enters the battlefield tapped.\n\nCycling 3 (3, discard this card: Draw a card.)', 'Maestros agents can lie low in high style at the opulent Shadow Hotel.', NULL, 'SNC', 'R', NULL, NULL, 'Land - Island Swamp Mountain', 91);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20015, 'Ziatora\'s Proving Ground', '', '(Tap: Add B, R, or G.)\n\nZiatora\'s Proving Ground Battlefield enters the battlefield tapped.\n\nCycling 3 (3, discard this card: Draw a card.)', 'Restless Riveteers can always find a sparring partner in the sprawling Treza warehouse.', NULL, 'SNC', 'R', NULL, NULL, 'Land - Swamp Mountain Forest', 29);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20016, 'Spara\'s Headquarters', '', '(Tap: Add G, W, or U.)\n\nSpera\'s Headquarters enters the battlefield tapped.\n\nCycling 3 (3, discard this card: Draw a card.)', 'To most, the Nido Sanctuary is an office complex. To the Brokers, it\'s a vault of secrets', NULL, 'SNC', 'R', NULL, NULL, 'Land - Forest Plains Island', 12);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20017, 'Jetmir\'s Garden', '', '(Tap: Add R, G, or W.)\n\nJetmir\'s Garden enters the battlefield tapped.\n\nCycling 3 (3, discard this card: Draw a card.)', 'The portable Cabareth grounds offer food, and the pefect place to shake off a tail.', NULL, 'SNC', 'R', NULL, NULL, 'Land - Mountain Forest Plains', 7);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (20018, 'Raffine\'s Tower', '', '(Tap; Add W, U, or B.)\n\nRaffine\'s Tower enters the battlefield tapped.\n\nCycling 3 (3, discard this card: Draw a card.)',  'The Obscura\'s Cloud Spire dominates the skyline, its eye a beacon of progress that sees all.', NULL, 'SNC', 'R', NULL, NULL, 'Land - Plains Island Swamp', 5);
...
INSERT INTO CARD_IN_DECK (DECK_NUMBER, CARD_NUMBER, COUNT) VALUES (102, 20018, 4); -- Raffine's Tower
INSERT INTO CARD_IN_DECK (DECK_NUMBER, CARD_NUMBER, COUNT) VALUES (102, 20015, 4); -- Ziatora's Proving Ground
INSERT INTO CARD_IN_DECK (DECK_NUMBER, CARD_NUMBER, COUNT) VALUES (102, 94, 1); -- Mountain
