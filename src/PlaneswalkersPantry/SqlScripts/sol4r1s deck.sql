...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (3, 'Syncopate', 'XU', 'Counter target spell unless its controller pays X Variable Colorless. If that spell is countered this way, exile it instead of putting it into its owner\'s graveyard.', '"Fool! Can\'t you see the tide has turned against you?"', NULL, '###', 'C', NULL, NULL, 'Instant', 50);
