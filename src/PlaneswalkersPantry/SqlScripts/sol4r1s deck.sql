...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (3, 'Syncopate', 'XU', 'Counter target spell unless its controller pays X Variable Colorless. If that spell is countered this way, exile it instead of putting it into its owner\'s graveyard.', '"Fool! Can\'t you see the tide has turned against you?"', NULL, 'ODY', 'C', NULL, NULL, 'Instant', 50);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (4, 'Thirst for Discovery', '2U', 'Draw three cards. Then discard two cards unless you discard a basic land card.', 'I knew he had left the castle now, and thought to use the opportunity to explore more than I had dared to do as yet.', NULL, 'VOW', 'U', NULL, NULL, 'Instant', 25);
...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (11, 'Silver Scrutiny', 'XUU', 'You may cast Silver Scrutiny as though it had flash if X is 3 or less.\n\nDraw X cards.', NULL, NULL, 'DMU', 'R', NULL, NULL, 'Sorcery', 5);
...
INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (16, 'Shivan Reef', '', 'Tap: Add Colorless.\n\nTap: Add B or R. Shivan Reef deals 1 damage to you.', NULL, NULL, 'INV', 'R', NULL, NULL, 'Land', 5);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (17, 'Mountain', '', 'Tap: Add R.', NULL, NULL, 'LEA', 'C', NULL, NULL, 'Land', 100);

INSERT INTO CARD (CARD_NUMBER, CARD_TITLE, MANA_COST, RULES_TEXT, FLAVOR_TEXT, CARD_IMAGE, SET_CODE, RARITY_CODE, POWER, TOUGHNESS, TYPE_LINE, NUMBER_OWNED)
VALUES (18, 'Island', '', 'Tap: Add B.', NULL, NULL, 'LEA', 'C', NULL, NULL, 'Land', 100);
